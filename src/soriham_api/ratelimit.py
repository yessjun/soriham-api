...
**해싱보다 먼저 막지 않으면 시도 제한이 아니라 메모리 고갈 표면이 된다.**

세는 축은 두 가지다.

- **출처(IP)별** — 한 곳에서 쏟아지는 시도를 막는다
- **출처와 대상의 짝** — 그 IP가 특정 계정이나 링크 하나를 두드리는 것을 막는다

**대상만으로는 절대 세지 않는다.** 이메일 하나를 전역으로 잠그면 남의 계정을 마음대로
잠그는 수단이 된다 — 막으려던 것보다 나쁜 것을 만든다.
"""
